...
map.getView().fit([16820849.989280, -4009665.734100, 16821532.949870, -4009166.922704], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Briars Sports Club - Data and Services Portal</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (182 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web-map is not a replacement for services searches and/or services locating. Any intrusive works, excavation, or other works requires appropriate WHS/OHS processes and systems. ';
            }
